...
public class TerminalKeeper {
     ...
     */
    public CommandArgs signIn() throws ChangeModException {
        ...
        signInCommand.setArgs(new String[]{signInCommand.getCommandName(), signInCommand.getLogin(), encrypt(password)});
